...
import { BankOutlined, HomeOutlined, TableOutlined, CheckOutlined, UnorderedListOutlined } from '@ant-design/icons';
...
import TransactionsPage from '../transactions/list-transactions';
...
const menu = [
    ...
    { name: <Link to="/transactions">Transações</Link>, icon: UnorderedListOutlined },
